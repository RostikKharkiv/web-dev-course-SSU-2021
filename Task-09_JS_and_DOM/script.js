...
function eleminationGame(count, step) 
{
    let list = [];
...
document.querySelector(".vowel-btn").onclick = function() {
    document.querySelector(".vowelResult").textContent = vowelsCount(document.getElementById("vowel").value);
}

document.querySelector(".degree-btn").onclick = function() {
    document.querySelector(".degreeResult").textContent = sumFormula(parseInt(document.getElementById("degree").value));
}

document.querySelector(".eleminate-btn").onclick = function() {
    document.querySelector(".eleminateResult").textContent = eleminationGame(parseInt(document.getElementById("eleminateN").value), parseInt(document.getElementById("eleminateM").value));
}
